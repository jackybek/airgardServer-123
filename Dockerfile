...
sudo cmake -G Ninja -S .. -DCMAKE_C_COMPILER=/usr/local/gcc14.2.0/bin/aarch64-linux-gnu-gcc-14.2.0 -DCMAKE_C_COMPILER_AR=/usr/local/gcc14.2.0/bin/aarch64-linux-gnu-gcc-ar14.2.0 
-DCMAKE_C_COMPILER_RANLIB=/usr/local/gcc14.2.0/bin/aarch64-linux-gnu-gcc-ranlib14.2.0 
